...
<head>
    ...
    <title>SIGMAG | Login</title><!--begin::Primary Meta Tags-->
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="title" content="SIGMAG | Dashboard">
    <meta name="author" content="Isaac Mendes">
    <meta name="description" content="SIGMAG - Gestão Predial">
...
<body class="login-page bg-body-secondary">
    <div class="login-box">
        <div class="login-logo"> <a href="../index2.html"><b>SIGMAG</b></a> </div> <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">Faça o login para iniciar</p>
                <form action="dashboard.php" post" class="mb-3">
